...
### Fitting function definition + fixed gamma parameter
fitters <- list(
  list("gauss", "ab", c(0.5))
  )
...
###
# fitting values for every function
...
#adding id of individual fit of psychometrical function and preparing data for later transfer
...
#fitting data by psychometric functions
