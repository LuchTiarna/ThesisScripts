...
setsOfPredictors <- list(
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 10,      id=1, distr=1),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 20,      id=2, distr=2),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 40,      id=3, distr=3),
  ...
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 320,     id=6, distr=6),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 640,     id=7, distr=7),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 1280,    id=8, distr=8),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 2560,    id=9, distr=9),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 5120,    id=10, distr=10),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 10240,   id=11, distr=11),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 20480,   id=12, distr=12),
  data.frame(predictor=seq(0.5,6.5,length.out = 320),   observations= 40960,   id=13, distr=13)
...
#Constructiong representation of Psychometric models based on given parameters
...
#adding noise parameters - IN this case not used - only for resons of compatibility with other experiments
...
###saving data to file
write.csv(generated_data.frame, "gen_sc_obs.data.csv")
